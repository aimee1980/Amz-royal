...
def product_search():
    ...
    return render_template('product_search.html', product_search= product_search)



@main.route('/best-sellers')
def product_search():
    #best_sellers
    return render_template('/best-sellers')
...
def product_search():
    ...
    return render_template('contact_us', contact_us= contact_us_)
"""